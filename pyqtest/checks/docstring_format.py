...
from pyqtest.baselines_engine import load_envelope, save_envelope
...
class TestDocstringFormat:
    ...
    def test_docstring_format(
        ...
        if regressions or new_files:
            lines = ["Docstring format violations (NumPy style via ruff D rules):"]
            if regressions:
