...
class TestAttributes:
    ...
    def test_satisfies_provider_protocol(provider: Provider) -> None:
        """Each provider structurally satisfies the pyqtest Provider Protocol."""
...
class TestEntryPoints:
    ...
    def test_entry_points_register_three_providers() -> None:
        ...
        assert eps.get("openai") == "pyqtest_cloud.providers.openai:OpenAIProvider"
        assert eps.get("gemini") == "pyqtest_cloud.providers.gemini:GeminiProvider"
