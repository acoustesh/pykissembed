...
are now driven by ``[tool.pyqtest]``.
"""
...
class _BaselineConfig(TypedDict, total=False):
    """Subset of ``[tool.pyqtest]`` that the complexity check uses."""
...
class TestDocstringCoverage:
    ...
    def test_docstring_coverage(pyqtest_paths: list[Path], update_baselines: bool) -> None:
...
class TestLineCount:
    ...
    @staticmethod
    @pytest.mark.complexity
    def test_file_line_counts(pyqtest_paths: list[Path], update_baselines: bool) -> None:
